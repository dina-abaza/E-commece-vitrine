...
export default function PrivacyPolicy() {
  return (
    <div dir="rtl" className="max-w-5xl mx-auto px-4 py-10 text-right text-gray-800 leading-loose">
      <h1 className="text-2xl font-bold text-blue-900 mb-6">سياسة الخصوصية</h1>

      <section className="mb-8">
        <h2 className="text-xl font-semibold text-blue-900">المقدمة</h2>
        <p>
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold text-blue-900">المادة 1: التسجيل والحساب</h2>
        <p>
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold text-blue-900">المادة 2: شروط وأحكام البيع</h2>
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold text-blue-900">المادة 3: الإرجاع والاسترداد</h2>
        <p>
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold text-blue-900">المادة 4: قواعد المحتوى</h2>
        <p>
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold text-blue-900">المادة 5: استخدام التطبيق</h2>
        <p>
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold text-blue-900">المادة 6: دور التطبيق كمتجر إلكتروني</h2>
        <p>
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold text-blue-900">المادة 7: الشروط العامة</h2>
        <p>
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold text-blue-900">المادة 8: المراجعة والتعديل</h2>
        <p>
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold text-blue-900">المادة 9: عدم التنازل</h2>
        <p>
      ...
      <section>
        <h2 className="text-xl font-semibold text-blue-900">المادة 10: بيانات الاتصال</h2>
